...
from app.backend.openapi.responses import DevicesRouteResponses
...
@router.post("/device",
             ...
             responses=DevicesRouteResponses.ADD_DEVICE,
...
@router.get("/devices",
            ...
            responses=DevicesRouteResponses.GET_DEVICES)
...
@router.post("/buy",
             ...
             responses=DevicesRouteResponses.BUY_DEVICES,
